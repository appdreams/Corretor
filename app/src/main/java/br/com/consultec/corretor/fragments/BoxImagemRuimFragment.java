 ...
 */
public class BoxImagemRuimFragment extends Fragment
{

    private String idCorretor           =   "";
    private String idProcessoSeletivo   =   "";

    private TextView txtTotalImagemRuim;

    private String totalImagemRuim;

    public BoxImagemRuimFragment()
    {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_box_imagem_ruim, container, false);
    }
    ...
    {
        txtTotalImagemRuim = (TextView) getView().findViewById(R.id.txtTotalImagemRuim);
    }
    ...
    public void carregaDadosVolley()
    {
        ...
        String URL = "http://consultec.com.br/APPS/CORRETOR/getDadosImagemRuim.php";
    ...
    private void separaDadosJSON(JSONObject json)
    {
        ...
        try {
            ...
            totalImagemRuim   =   jsonArray.getJSONObject((int)0).getString("imagem_ruim").toString();

            //Log.i("PAULO", " -> "+jsonArray.getJSONObject((int)0).getString("hoje").toString());

            setDadosTotalImagemRuim(totalImagemRuim);
    ...
    private void setDadosTotalImagemRuim(String totalImagemRuim)
    {
        txtTotalImagemRuim.setText(totalImagemRuim);
    }
