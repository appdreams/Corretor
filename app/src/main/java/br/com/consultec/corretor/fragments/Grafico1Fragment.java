...
public class Grafico1Fragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        return inflater.inflate(R.layout.fragment_grafico1, container, false);
    }
    ...
    {
        chart1 = (PieChartView) getView().findViewById(R.id.chart1);
    }
    ...
    private void reset() {
        chart1.setCircleFillRatio(1.0f);
        hasLabels = false;
    ...
    private void toggleLabelsOutside() {
        ...
        if (hasLabelsOutside) {
            hasLabels = true;
            hasLabelForSelected = false;
            chart1.setValueSelectionEnabled(hasLabelForSelected);
        }

        if (hasLabelsOutside) {
            chart1.setCircleFillRatio(0.7f);
        } else {
            chart1.setCircleFillRatio(1.0f);
        }
