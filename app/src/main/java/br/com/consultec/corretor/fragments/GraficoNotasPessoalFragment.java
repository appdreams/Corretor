...
public class GraficoNotasPessoalFragment extends Fragment
{
    ...
    private void generateData(String nota0, String nota1, String nota2, String nota3, String nota4, String nota5, String nota6, String nota7, String nota8, String nota9, String nota10)
    {
        ...
        //Log.i("PAULO", "totalNota0 -> "+nota0);
        //Log.i("PAULO", "totalNota1 -> "+nota1);
        //Log.i("PAULO", "totalNota2 -> "+nota2);
        //Log.i("PAULO", "totalNota3 -> "+nota3);
        //Log.i("PAULO", "totalNota4 -> "+nota4);
        //Log.i("PAULO", "totalNota5 -> "+nota5);
        //Log.i("PAULO", "totalNota6 -> "+nota6);
        //Log.i("PAULO", "totalNota7 -> "+nota7);
        //Log.i("PAULO", "totalNota8 -> "+nota8);
        //Log.i("PAULO", "totalNota9 -> "+nota9);
        //Log.i("PAULO", "totalNota10 -> "+nota10);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL,
                new Response.Listener<String>()
                {
                    ...
                    public void onResponse(String response)
                    {
                        try
                        {
                            //Log.i("PAULO", "RESP P -> "+response.toString());
